...
export const api = {
  ...
  getStations: (workspaceId: string) =>
    request<Station[]>(
      `/stations?workspaceId=${encodeURIComponent(workspaceId)}`
    ),
  addStation: (
    workspaceId: string,
    name: string,
  ...
  getMessages: (workspaceId: string) =>
    request<Message[]>(
      `/messages?workspaceId=${encodeURIComponent(workspaceId)}`
    ),
  sendMessage: (
    workspaceId: string,
    text: string,
  ...
  getSettings: (workspaceId: string) =>
    request<AppSettings>(
      `/settings?workspaceId=${encodeURIComponent(workspaceId)}`
    ),
